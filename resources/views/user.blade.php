...
{{-- @auth --}}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            // then the controller will handle that uri to use specific method called get_user_levels() inside UserController
            ...
            // after the submission, the ajax request will pass the formResetUserPass(form) of data(input) in the uri(reset_password)
